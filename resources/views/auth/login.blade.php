...
<body class="min-h-screen bg-[#f6f6f7] font-sans antialiased flex items-center justify-center">
    ...
    <div class="w-full max-w-sm px-6">
        <div class="mb-8 text-center">
            ...
            <h1 class="text-2xl font-semibold text-[#2f2f35] tracking-tight">{{ __('portal.sign_in_title') }}</h1>
            <p class="mt-2 text-sm text-[#7c7c86]">{{ __('portal.google_btn') }}</p>
        </div>
        ...
        <div class="bg-white border border-[#eaeaea] rounded-2xl p-8 shadow-sm">
            ...
            >
                ...
                {{ __('portal.continue_google') }}
            </a>
        </div>

        <p class="mt-6 text-center text-xs text-[#9ca3af]">
            {{ __('portal.terms_notice') }}
        </p>
    </div>
